...
export const INITIAL_RENTALS: RentalProperty[] = [
  {
    ...
    meterReadings: [
      {
        id: 'meter-seed-water-2',
        date: '2026-04-09',
        utilityType: 'water',
        readingValue: 1977.0,
        previousReadingValue: 1956.0,
        consumption: 21.0,
        meterNumber: '211001886',
        readingType: 'Actual',
        source: 'pdf-extracted',
        notes: 'CoJ statement reading period 2026/03/08 - 2026/04/09',
        createdAt: '2026-04-10T08:00:00Z',
      },
      {
        id: 'meter-seed-water-1',
        date: '2026-03-08',
        utilityType: 'water',
        readingValue: 1956.0,
        previousReadingValue: 1934.0,
        consumption: 22.0,
        meterNumber: '211001886',
        readingType: 'Actual',
        source: 'pdf-extracted',
        notes: 'CoJ statement baseline',
        createdAt: '2026-03-09T08:00:00Z',
      },
      {
        id: 'meter-seed-elec-1',
        date: '2026-02-26',
        utilityType: 'electricity',
        readingValue: 39504.0,
        previousReadingValue: 39302.0,
        consumption: 202.0,
        meterNumber: '10003374',
        readingType: 'Actual',
        source: 'pdf-extracted',
        notes: 'Eskom invoice period 2026/02/17 - 2026/02/26',
...
export const INITIAL_FLIPS: FlipProject[] = [
  {
    ...
    monthlyLeviesZAR: 0, // Freehold title strictly R0 levies
